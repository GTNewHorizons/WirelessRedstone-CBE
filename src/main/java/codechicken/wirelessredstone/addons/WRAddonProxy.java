...
public class WRAddonProxy {
    ...
    private void addRecipes() {
        GameRegistry.addRecipe(
                ...
                Items.iron_ingot,
                't',
                WirelessRedstoneCore.wirelessTransceiver);

        GameRegistry.addRecipe(
                new ItemStack(remote),
                "t",
                "B",
                'B',
                Blocks.stone_button,
        ...
        GameRegistry.addRecipe(
                new ItemStack(sniffer),
                "dtd",
                "rBr",
                "SSS",
                'd',
                WirelessRedstoneCore.recieverDish,
                't',
                WirelessRedstoneCore.wirelessTransceiver,
                'r',
                Items.redstone,
        ...
        GameRegistry.addRecipe(
                ...
                Items.paper,
                't',
                new ItemStack(triangulator, 1, OreDictionary.WILDCARD_VALUE));
        ...
        GameRegistry.addRecipe(
                ...
                "tO ",
                'p',
                WirelessRedstoneCore.retherPearl,
                't',
                WirelessRedstoneCore.blazeTransceiver,
                'r',
                Items.redstone,
                'g',
        ...
        GameRegistry.addRecipe(
                new ItemStack(psniffer),
                "dtd",
                "rBr",
                "SSS",
                'd',
                WirelessRedstoneCore.blazeRecieverDish,
                't',
                WirelessRedstoneCore.blazeTransceiver,
                'r',
                Items.redstone,
